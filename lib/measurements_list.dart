...
class _MeasurementsListPageState extends State<MeasurementsListPage> {
  ...
  void _navigateToForm({Measurement? measurement}) async {
    final result = await Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => MeasurementForm(initialMeasurement: measurement),
      ),
    );
    // If form returned true (measurement saved), refresh the list
    if (result == true) {
      _reload();
    }
  }
